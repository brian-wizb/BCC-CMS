...
<div class="space-y-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex flex-wrap items-center gap-2">
            <a href="{{ route('department-expenses.export', request()->only(['search', 'department', 'date_from', 'date_to'])) }}" class="btn-secondary flex items-center gap-1.5">
    ...
    <x-ui.date-range-filters :action="route('department-expenses.index')" :date-from="$dateFrom" :date-to="$dateTo" />
