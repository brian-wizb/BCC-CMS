<x-layouts.app title="Add Giving">
    ...
    <div class="mx-auto max-w-2xl space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <h3 class="text-xl font-semibold text-[var(--color-ink-950)]">Add Giving</h3>
                </div>
            </div>
        ...
        <article class="surface-card p-6">
            <form method="POST" action="{{ route('givings.store') }}" enctype="multipart/form-data" class="space-y-5">
                @csrf
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit" class="btn-primary flex items-center gap-1.5"><i class="fas fa-save text-xs"></i> Save Giving</button>
                </div>
            </form>
        </article>
    </div>
