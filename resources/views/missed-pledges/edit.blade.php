<x-layouts.app title="Edit Missed Pledge">
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <h3 class="text-xl font-semibold text-[var(--color-ink-950)]">Edit Missed Pledge</h3>
            </div>
        </div>

        <div class="mx-auto max-w-2xl">
            <article class="surface-card p-6">
                <form method="POST" action="{{ route('missed-pledges.update', $missedPledge) }}" class="space-y-5">
                    @csrf @method('PUT')
                    ...
                    <div>
                        ...
                        <select name="pledge_id" required class="form-input w-full">
                            ...
                            @foreach($pledges as $pledge)
                                <option value="{{ $pledge->id }}" {{ old('pledge_id', $missedPledge->pledge_id) == $pledge->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="date" name="missed_date" value="{{ old('missed_date', $missedPledge->missed_date) }}" required class="form-input w-full">
                    ...
                    <div>
                        ...
                        <textarea name="reason" rows="3" class="form-input w-full" placeholder="Explain why the pledge was missed…">{{ old('reason', $missedPledge->reason) }}</textarea>
                    ...
                    <div class="flex items-center justify-end gap-3 pt-2">
                        ...
                        <button type="submit" class="btn-primary flex items-center gap-1.5"><i class="fas fa-save text-xs"></i> Update Record</button>
                    </div>
                </form>
            </article>
        </div>
